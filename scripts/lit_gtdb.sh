...
grep -E "$SPECIES_PATTERN" /shares/sander.imm.uzh/MM/kansasii/lit/gtdb/bac120_metadata_r232.tsv > kansasii_complex_rows_metadata.tsv
grep -E "$SPECIES_PATTERN" /shares/sander.imm.uzh/MM/kansasii/lit/gtdb/bac120_taxonomy_r232.tsv > kansasii_complex_rows_taxonomy.tsv
...
# ---------------------------------------------------------------------
REFDIR=/shares/sander.imm.uzh/MM/kansasii/data/reference_genomes
mkdir -p "$REFDIR"
