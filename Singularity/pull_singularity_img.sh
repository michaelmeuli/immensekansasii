...
singularity build --sandbox ${INSTALL_PATH}/quay.io-biocontainers-tb-profiler:6.3.0--pyhdfd78af_0 docker://quay.io/biocontainers/tb-profiler:6.3.0--pyhdfd78af_0