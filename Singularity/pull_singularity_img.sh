...
singularity build --sandbox -F ${INSTALL_PATH}/quay.io-biocontainers-unicycler-0.5.0--py38h5cf8b27_3.img docker://quay.io/biocontainers/unicycler:0.5.0--py38h5cf8b27_3
