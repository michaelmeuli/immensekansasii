...
singularity build --sandbox ${INSTALL_PATH}/quay.io-biocontainers-unicycler-0.4.8--py39h98c8e45_5.img docker://quay.io/biocontainers/unicycler:0.4.8--py39h98c8e45_5
