...
process links_for_transfer {
  ...
  ln -s $PWD/assembly/results/${sample_id}/2_annotation/${sample_id}.fna $PWD/${params.run_id}_transfer_result/genomes/\$species/
  ln -s $PWD/assembly/results/${sample_id}/3_quality/remapping/${sample_id}_concatenated_contigs.fna $PWD/${params.run_id}_transfer_result/genomes_one_contig/\$species/
