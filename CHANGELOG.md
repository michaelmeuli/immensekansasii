...
- BUSCO temporary files are removed in work directory to save space
...
- Short-read input reads have to end with _R1 or _R2.fastq.gz to ensure correct interpretation when hybrid assembly is implemented
